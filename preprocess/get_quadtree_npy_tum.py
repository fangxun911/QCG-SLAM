...
def main():
    ...
    scene_list = [
        ...
        "rgbd_dataset_freiburg1_room", "rgbd_dataset_freiburg2_xyz",
        "rgbd_dataset_freiburg3_long_office_household"
    ]
    scene_name = scene_list[4]  # 选择场景
    data_root = Path(r'C:\Users\Ad\Desktop\QCG-SLAM\data\TUM_RGBD') / scene_name
