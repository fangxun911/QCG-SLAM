...
from utils.gs_external import (calc_ssim, build_rotation, densify,
...
def initialize_first_timestep(dataset, num_frames, lrs_dict,
...
def offline_splatting(config: dict):
    ...
    params, variables, optimizer, intrinsics, w2c, cam = (
        initialize_first_timestep(dataset, num_frames,
    ...
    for time_idx in tqdm(range(num_frames)):
        ...
        if time_idx > 0:
            params, variables = add_new_gaussians(
                params, variables, curr_data, config['train']['sil_thres'],
                time_idx, config['mean_sq_dist_method'],
                config['gaussian_distribution'])
