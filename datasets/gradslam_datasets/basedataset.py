...
class GradSLAMDataset(torch.utils.data.Dataset):
    ...
    def _preprocess_poses(self, poses: torch.Tensor):
        ...
        # torch.save(output, "/home/fx/桌面/scannetpp_poses.pt")
        return output
    ...
    def __getitem__(self, index):
        ...
        quadtree_path = self.quadtree_paths[index]
        ...
        quadtree = np.load(quadtree_path).astype(np.int64)
        quadtree = torch.from_numpy(quadtree)
