...
class AzureKinectDataset(GradSLAMDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # # check if a file named 'poses_global_dvo.txt' exists in the basedir /
        # sequence folder
        # if os.path.isfile(os.path.join(basedir, sequence,
    ...
    def load_poses(self):
        if self.pose_path is None:
            print("WARNING: Dataset does not contain poses. Returning identity "
                  "transform.")
            ...
            #
            # on the other hand, the "poses_o3d.txt" or "poses_dvo.txt" files
            # have the format
