...
scenes = [
    "freiburg1_desk", "freiburg1_desk2", "freiburg1_room", "freiburg2_xyz",
...
tracking_iters = 300
coarse_mapping_iters = 5
fine_mapping_iters = 60
# mapping_iters = 30
scene_radius_depth_ratio = 2

group_name = "TUM"
run_name = f"{scene_name}_seed{seed}_0107"
...
config = dict(
    ...
    quadtree_contrast_threshold=0.01,
    ...
    mapping=dict(
        ...
        fine_lrs=dict(
            means3D=0.00015,
            rgb_colors=0.004,
            unnorm_rotations=0.0015,
            logit_opacities=0.075,
            log_scales=0.0015,
            cam_unnorm_rots=0.0000,
            cam_trans=0.0000,
        ),
