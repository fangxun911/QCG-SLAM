...
tracking_iters = 40
coarse_mapping_iters = 40
fine_mapping_iters = 60

today = datetime.now().strftime("%m%d")
group_name = "Replica"
# run_name = f"{scene_name}_seed{seed}_1126_0.5ColorError_GlobalOptimization"
run_name = f"{scene_name}_seed{seed}_{today}_GO_1"
...
config = dict(
    ...
    quadtree_contrast_threshold=0.1, # 四叉树对比度阈值要求
    hole_threshold=0.008, # 空洞比例，用来判断是否用四叉树进行densification
